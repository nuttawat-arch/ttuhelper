...
`ttuhelper` is a modified and expanded helper for running TTUtilities Unified Docker images.
...
The bot image managed by this helper is TTUtilities Unified. TTUtilities Unified also incorporates ideas and functionality inspired by TTMediaBot by gumerov-amir, but the helper repository does not vendor the TTMediaBot application source.
